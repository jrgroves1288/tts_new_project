...
tiecount = 0
 until  (playercount == 5 || cpucount == 5)
  ...
  puts "You thow #{player1}"
  puts "CPU throws #{cpuplayer}"
  if (player1 == "rock" && cpuplayer == "scissors") || (player1 == "paper" && cpuplayer == "rock") || (player1 == "scissors" && cpuplayer == "paper")
    puts "You Win!"
    playercount +=1
